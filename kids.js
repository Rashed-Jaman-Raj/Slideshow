document.addEventListener('DOMContentLoaded', () => {
  ...
  const validTypes = [
    "Kids Bath Toys", "Kids Shoes", "Kids Dungarees", "Kids Jeans",
    "Kids Raincoat", "Kids Shirt", "Kids Girls Jeans", "Kids Girls Pants",
    "Kids Gift Pack", "Kids Girls Frock", "Kids Girls T-Shirt", "Others"
  ];
  ...
  function getFilteredProducts() {
    const womenProducts = allProducts.filter(p => p.category?.toLowerCase().trim() === 'kids');

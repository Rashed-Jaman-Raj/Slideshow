document.addEventListener('DOMContentLoaded', () => {
  ...
  const validTypes = [
    "Kids Bath Toys", "Women Shoes", "Long Tunic", "Ear Ring", "Hand Bag", "Tunic With Shrug", "Men Waistcoat", "Men Shorts", "Men Pajama", "Men Panjabi", "Men Shoes", "Gown", "Shari",  "Others"
  ];
  ...
  function getFilteredProducts() {
    const womenProducts = allProducts.filter(p => p.category?.toLowerCase().trim() === 'flat');
